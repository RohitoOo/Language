...
var skel = function() {
  ...
  var t = {
    ...
    trigger: function(e) {
      if (t.events[e] && 0 != t.events[e].length)
        return t.iterate(t.events[e], function(n) {
          t.events[e][n]()
        }),
        t
    },
    ...
    initVars: function() {
      ...
      t.vars.os = e,
      t.vars.osVersion = n,
      t.vars.IEVersion = "ie" == t.vars.browser
        ? t.vars.browserVersion
        : 99,
      t.vars.touch = "wp" == t.vars.os
